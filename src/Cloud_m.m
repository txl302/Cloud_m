...
% Last Modified by GUIDE v2.5 06-Oct-2017 11:31:23
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
ip_addr = get(handles.edit1, 'String')
port = str2num(get(handles.edit2, 'String'))

echotcpip('on', port)
tcpclient = tcpip(ip_addr, port)
fopen(tcpclient)

img = fread(tcpclient, tcpclient.ByteAvailable)
